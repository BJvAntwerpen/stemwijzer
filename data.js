...
/* example subject with parties and their positions:
{
	...
	parties: [
		{name: '', position: 'pro', explanation: ''},
		{name: '', position: 'ambivalent', explanation: ''},
		{name: '', position: 'contra', explanation: ''},
	]
}
*/
	{
	...
	},//4
	{
		...
		parties: [
			...
			{name:'Partij voor de Dieren',position:'pro',explanation:'Het gebruik en de productie van softdrugs wordt gelegaliseerd, zodat teelt legaal wordt en er accijns over kan worden geheven. De overheid draagt zorg voor een goede voorlichting over de gezondheidsrisico’s van het gebruik van softdrugs.'},
			...
			{name:'VNL',position:'pro',explanation:'De politie moet zich bezighouden met de bestrijding van echte criminaliteit. Wiet is niet schadelijker dan alcohol en tabak. Harddrugs (bijvoorbeeld heroïne) pakken we keihard aan.'},
			...
			{name: 'SGP', position: 'contra', explanation: 'De SGP vindt het gedoogbeleid onduidelijk en halfslachtig. De indruk wordt gewekt dat zo’n beetje alles kan of door de vingers wordt gezien. Het gedoogbeleid moet daarom per direct worden afgeschaft. In plaats van gedogen wil de SGP de wet handhaven. De productie van drugs blijft dan ook strafbaar als het aan de SGP ligt. Aan gereguleerde wietteelt van de overheid moeten we niet beginnen.'}
		]
	},//5
	{
